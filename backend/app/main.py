"""
EarthPulse - FastAPI Main Application
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("🌍 EarthPulse Backend Starting...")
    ...
    # Shutdown
    logger.info("🌍 EarthPulse Backend Shutting Down...")
...
app = FastAPI(
    ...
    description="EarthPulse - Interactive NASA satellite data visualization for environmental change analysis",
